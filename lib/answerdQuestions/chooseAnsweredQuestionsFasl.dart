...
import '../aboutUs.dart';
import '../ourNews.dart';
import 'answeredQuestionsMain.dart';

class ChooseAnsweredQuestionsFasl extends StatefulWidget {
  final String bab;
  final String recievedSubject;
  final String recievedLevel;

  const ChooseAnsweredQuestionsFasl({
    Key key,
    this.bab,
  ...
  @override
  _ChooseAnsweredQuestionsFaslState createState() =>
      _ChooseAnsweredQuestionsFaslState();
}

class _ChooseAnsweredQuestionsFaslState
    extends State<ChooseAnsweredQuestionsFasl> {
  var fasl = [];
