...
import '../aboutUs.dart';
import '../ourNews.dart';
import 'chooseTrainingNumber.dart';

class ChooseTrainingFasl extends StatefulWidget {
  final String bab;
  final String recievedSubject;
  final String recievedLevel;

  const ChooseTrainingFasl({
    Key key,
    this.bab,
  ...
  @override
  _ChooseTrainingFaslState createState() => _ChooseTrainingFaslState();
}

class _ChooseTrainingFaslState extends State<ChooseTrainingFasl> {
  var fasl = [];
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ChooseTrainingNumber(
                                      fasl: fasl[index],
