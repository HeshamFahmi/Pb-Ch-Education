...
class TraningResult extends StatefulWidget {
  final int rights;
  ...
  @override
  _TraningResultState createState() => _TraningResultState();
}

class _TraningResultState extends State<TraningResult> {
  @override
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Column(
                            ...
                            children: <Widget>[
                              Text(
                                "Question 1 : " + widget.userQuestions[index],
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                    color: Colors.green[900]),
                              ...
                              Text(
                                "Your Answer : " + widget.userAnswers[index],
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                    color: Colors.green[900]),
